package cn.ravanla.flash.core.aop;

import cn.ravanla.flash.bean.core.BussinessLog;
import cn.ravanla.flash.bean.dictmap.base.AbstractDictMap;
import cn.ravanla.flash.core.factory.Contrast;
import cn.ravanla.flash.core.log.LogManager;
import cn.ravanla.flash.core.log.LogTaskFactory;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(cn.ravanla.flash.bean.core.BussinessLog)")
